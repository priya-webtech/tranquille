<x-app-layout>
    <!-- [ breadcrumb ] start -->
    @livewire('breadcrumb', ['title' => 'Companion Report List', 'breadcrumburl' => 'dashboard', 'breadcrumbtitle'=> 'Home'])
                ...
                <div class="card user-profile-list table-bg">
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="companionreport-list-table" class="table nowrap display dataTable no-footer">
                                <thead>
                                    <tr>
                                        <th>Serial No.</th>
                                        <th>User Name</th>
    ...
    <script type="text/javascript">
      $(function () {
        ...
        var table = $('#companionreport-list-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('companionReport') }}",
            columns: [
